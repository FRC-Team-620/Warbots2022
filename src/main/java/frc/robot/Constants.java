...
public final class Constants {
    ...
    public static final double openLoopRampRate = 0.6; // 0.6 sec to full velocity
    public static final int currentLimit = 45; // maxmium amps
    public static final double conversionFactor = Constants.gearRatio
            * Constants.wheelDiameterInInches
            * Constants.inchesToMetersFactor
            * Math.PI;
